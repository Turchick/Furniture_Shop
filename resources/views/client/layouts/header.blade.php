    ...
    <div id="nav-section">
        <div class="mega-menus top-header">
            <nav class="p-static hidden-md-down">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12 hidden-xs float-left text-center-sm no-float-sm no-padding">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 float-right hidden-xs pad-right-0">
